...
import { GetSides, AddPackage } from "../../redux/apiCalls/subscribersApiCall";
...
export const FormAddPackgeDepartment = () => {
  ...
  const addPackageDepartment = useRef("");
  ...
  const handelAddPackageDepartment = async (e) => {
    e.preventDefault();
    const IDside = sideSubject;
    const side = selectedSide;
    const expirationDate = addPackageDepartment.current.expirationDate.value;
    const infoPackage = {
      number: 1,
      expirationDate: expirationDate,
      side: side,
      subject: ["65e2265dcc324084e2f"],
      all: IDside,
    };
      ...
      <div className="material-add w-full flex items-start gap-[120px] bg-[white]  py-[70px] px-[80px] rounded-[15px] mt-[43px]">
        <div className="inputs flex-1">
          <form
            ...
            ref={addPackageDepartment}
            onSubmit={handelAddPackageDepartment}
          >
