  ...
  return (
    <Fragment>
      <div className="menu w-[278px] h-screen relative bg-white px-[15px]">
        ...
        <button className="w-[209px] flex items-center p-[15px] gap-[10px] mt-[10px]  transition duration-200 rounded-md hover:bg-[#e9e9e966]">
          <div className="w-[24px] h-[24px] ">
            <img src="/assests/menuIcon/logOut.svg" alt="" />
          </div>
          <span
            className="text-[14px] font-[500] text-main "
            onClick={() => {
              deleteIdCookie();
